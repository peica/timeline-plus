      ...
      if (typeof this.itemSet.options.order === 'function') {
        ...
        if (this.doInnerStack && this.itemSet.options.stackSubgroups) {
          ...
          for (const subgroup in this.subgroups) {
            let visibleItemsInSubgroup = this._updateItemsInRange(this.orderedItems, this.subgroups[subgroup].items, range)
            visibleSubgroups[subgroup] = visibleItemsInSubgroup.slice().sort((a, b) => me.itemSet.options.order(a.data, b.data));
          }
